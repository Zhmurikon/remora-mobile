...
/// * [visibility] 
@BuiltValue()
abstract class SetDetail implements Built<SetDetail, SetDetailBuilder> {
  ...
  factory SetDetail([void updates(SetDetailBuilder b)]) = _$SetDetail;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SetDetailBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SetDetail> get serializer => _$SetDetailSerializer();
}

class _$SetDetailSerializer implements PrimitiveSerializer<SetDetail> {
  @override
  final Iterable<Type> types = const [SetDetail, _$SetDetail];

  @override
  final String wireName = r'SetDetail';
  ...
  void _deserializeProperties(
    ...
    required SetDetailBuilder result,
  ...
  @override
  SetDetail deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SetDetailBuilder();
