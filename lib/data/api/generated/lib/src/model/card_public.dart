...
/// * [wrongTermAnswers] 
@BuiltValue()
abstract class CardPublic implements Built<CardPublic, CardPublicBuilder> {
  ...
  factory CardPublic([void updates(CardPublicBuilder b)]) = _$CardPublic;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CardPublicBuilder b) => b
      ..contentType = ContentType.text;

  @BuiltValueSerializer(custom: true)
  static Serializer<CardPublic> get serializer => _$CardPublicSerializer();
}

class _$CardPublicSerializer implements PrimitiveSerializer<CardPublic> {
  @override
  final Iterable<Type> types = const [CardPublic, _$CardPublic];

  @override
  final String wireName = r'CardPublic';
  ...
  void _deserializeProperties(
    ...
    required CardPublicBuilder result,
  ...
  @override
  CardPublic deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CardPublicBuilder();
