...
part of 'set_detail.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$SetDetail extends SetDetail {
  @override
  ...
  factory _$SetDetail([void Function(SetDetailBuilder)? updates]) =>
      (SetDetailBuilder()..update(updates))._build();
  ...
  _$SetDetail._(
      ...
      : super._();
  @override
  SetDetail rebuild(void Function(SetDetailBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SetDetailBuilder toBuilder() => SetDetailBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SetDetail &&
        cards == other.cards &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SetDetail')
          ..add('cards', cards)
...
class SetDetailBuilder implements Builder<SetDetail, SetDetailBuilder> {
  _$SetDetail? _$v;
  ...
  SetDetailBuilder() {
    SetDetail._defaults(this);
  }

  SetDetailBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(SetDetail other) {
    _$v = other as _$SetDetail;
  }

  @override
  void update(void Function(SetDetailBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SetDetail build() => _build();

  _$SetDetail _build() {
    _$SetDetail _$result;
    try {
      _$result = _$v ??
          _$SetDetail._(
            cards: cards.build(),
            cardsCount: BuiltValueNullFieldError.checkNotNull(
                cardsCount, r'SetDetail', 'cardsCount'),
            createdAt: BuiltValueNullFieldError.checkNotNull(
                createdAt, r'SetDetail', 'createdAt'),
            description: BuiltValueNullFieldError.checkNotNull(
                description, r'SetDetail', 'description'),
            folderId: folderId,
            id: BuiltValueNullFieldError.checkNotNull(id, r'SetDetail', 'id'),
            langDefinition: BuiltValueNullFieldError.checkNotNull(
                langDefinition, r'SetDetail', 'langDefinition'),
            langTerm: BuiltValueNullFieldError.checkNotNull(
                langTerm, r'SetDetail', 'langTerm'),
            slug: BuiltValueNullFieldError.checkNotNull(
                slug, r'SetDetail', 'slug'),
            title: BuiltValueNullFieldError.checkNotNull(
                title, r'SetDetail', 'title'),
            updatedAt: BuiltValueNullFieldError.checkNotNull(
                updatedAt, r'SetDetail', 'updatedAt'),
            visibility: BuiltValueNullFieldError.checkNotNull(
                visibility, r'SetDetail', 'visibility'),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'SetDetail', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
