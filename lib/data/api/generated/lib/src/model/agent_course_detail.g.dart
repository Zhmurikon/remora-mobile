...
part of 'agent_course_detail.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AgentCourseDetail extends AgentCourseDetail {
  @override
  ...
  @override
  final BuiltList<AgentSectionDetail> sections;
  @override
  final String slug;
  @override
  ...
  factory _$AgentCourseDetail(
          [void Function(AgentCourseDetailBuilder)? updates]) =>
      (AgentCourseDetailBuilder()..update(updates))._build();

  _$AgentCourseDetail._(
      ...
      : super._();
  @override
  AgentCourseDetail rebuild(void Function(AgentCourseDetailBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  AgentCourseDetailBuilder toBuilder() =>
      AgentCourseDetailBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AgentCourseDetail &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AgentCourseDetail')
...
class AgentCourseDetailBuilder
    implements Builder<AgentCourseDetail, AgentCourseDetailBuilder> {
  _$AgentCourseDetail? _$v;
  ...
  ListBuilder<AgentSectionDetail>? _sections;
  ListBuilder<AgentSectionDetail> get sections =>
      _$this._sections ??= ListBuilder<AgentSectionDetail>();
  set sections(ListBuilder<AgentSectionDetail>? sections) =>
  ...
  AgentCourseDetailBuilder() {
    AgentCourseDetail._defaults(this);
  }

  AgentCourseDetailBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(AgentCourseDetail other) {
    _$v = other as _$AgentCourseDetail;
  }

  @override
  void update(void Function(AgentCourseDetailBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AgentCourseDetail build() => _build();

  _$AgentCourseDetail _build() {
    _$AgentCourseDetail _$result;
    try {
      _$result = _$v ??
          _$AgentCourseDetail._(
            createdAt: BuiltValueNullFieldError.checkNotNull(
                createdAt, r'AgentCourseDetail', 'createdAt'),
            description: description,
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'AgentCourseDetail', 'id'),
            isListed: BuiltValueNullFieldError.checkNotNull(
                isListed, r'AgentCourseDetail', 'isListed'),
            isPublished: BuiltValueNullFieldError.checkNotNull(
                isPublished, r'AgentCourseDetail', 'isPublished'),
            likedByMe: likedByMe,
            likesCount: likesCount,
            moderationStatus: BuiltValueNullFieldError.checkNotNull(
                moderationStatus, r'AgentCourseDetail', 'moderationStatus'),
            publishedAt: publishedAt,
            revision: BuiltValueNullFieldError.checkNotNull(
                revision, r'AgentCourseDetail', 'revision'),
            savesCount: savesCount,
            sections: sections.build(),
            slug: BuiltValueNullFieldError.checkNotNull(
                slug, r'AgentCourseDetail', 'slug'),
            tags: tags.build(),
            title: BuiltValueNullFieldError.checkNotNull(
                title, r'AgentCourseDetail', 'title'),
            updatedAt: BuiltValueNullFieldError.checkNotNull(
                updatedAt, r'AgentCourseDetail', 'updatedAt'),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'AgentCourseDetail', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
