...
/// * [updatedAt] 
@BuiltValue()
abstract class CourseSummary implements Built<CourseSummary, CourseSummaryBuilder> {
  ...
  factory CourseSummary([void updates(CourseSummaryBuilder b)]) = _$CourseSummary;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CourseSummaryBuilder b) => b
      ..description = ''
      ..likedByMe = false
      ..likesCount = 0
      ..savesCount = 0;
  ...
  static Serializer<CourseSummary> get serializer => _$CourseSummarySerializer();
}

class _$CourseSummarySerializer implements PrimitiveSerializer<CourseSummary> {
  @override
  final Iterable<Type> types = const [CourseSummary, _$CourseSummary];

  @override
  final String wireName = r'CourseSummary';
  ...
  void _deserializeProperties(
    ...
    required CourseSummaryBuilder result,
  ...
  @override
  CourseSummary deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CourseSummaryBuilder();
